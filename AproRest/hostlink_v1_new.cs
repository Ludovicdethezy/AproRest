...
namespace AproRest
{
    ...
    {
        public string _baseUrl= "http://localhost:8018/api/v1/";
    ...
    public partial class ParameterClient 
    {
        ...
        public ParameterClient(System.Net.Http.HttpClient httpClient)
        {
            _httpClient = httpClient; 
            _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings);
        }
    ...
    {
        private string _baseUrl = "http://localhost:8018/api/v1/";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    ...
    /// <summary>An AGV has either completed an operation, the operation has failed, or the operation was interrupted.
    /// 
